            ...
            <PopoverGroup class="hidden lg:ml-8 lg:block lg:self-stretch">
              <div class="flex h-full space-x-8">
                <!-- <a
                  ...
                  :key="page.name"
                  :href="page.href"
                  class="border-indigo-600 text-indigo-600 flex items-center text-sm font-medium text-gray-700 hover:text-gray-800"
                  >{{ page.name }}</a
                > -->
                <router-link
                  v-for="page in navigation.pages"
                  :key="page.name"
                  :to="{ name: page.routeName }"
                  class="border-indigo-600 text-indigo-600 flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out"
                >
                  {{ page.name }}
                </router-link>
              </div>

...
<template>
  <div class="bg-white">
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-20 sm:py-18 lg:py-15">
        ...
        <div class="text-center">
          ...
          >
            Trouvez votre compagnon idéal avec YAP aujourd'hui !
          </h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">
            Découvrez notre vaste sélection d'animaux de compagnie, des chiots
